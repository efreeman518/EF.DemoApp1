namespace Application.Contracts.Constants
{
    ...
    {
        //Error messages
        public const string ERROR_ITEM_EXISTS = "Item already exists";
        ...
        public const string ERROR_RULE_NAME_LENGTH_MESSAGE = "Name is too short; length must be >= ";
        public const string ERROR_RULE_NAME_INVALID_MESSAGE = "Name is invalid";
