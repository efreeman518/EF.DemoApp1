...
namespace Test.Endpoints
{
    public static class HttpClientExtensions
    {
        ...
        /// <returns></returns>
        public static async Task<(HttpResponseMessage, TResponse?)> HttpRequestAndResponse<TRequest, TResponse>(this HttpClient client, HttpMethod method, string url, TRequest? payload, NameValueCollection? headers = null, bool ensureSuccessStatusCode = true)
            //where TResponse : class
        {
            ...
            TResponse? response = await JsonSerializer.DeserializeAsync<TResponse>(s, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
