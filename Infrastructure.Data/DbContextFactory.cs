...
/// First run in PMC:
/// $env:EFCORETOOLSDB = "Server=localhost;Database=ecs-sample-db;Integrated Security=true;MultipleActiveResultsets=true;Column Encryption Setting=enabled;"
...
/// $env:AKVCMKURL = "https://ecsvault-dev.vault.azure.net/keys/SQL-ColMaskerKey-Default/abc123"
